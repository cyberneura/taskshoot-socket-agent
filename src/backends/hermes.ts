...
/**
 * Appended to the shared policy for this backend only.
 *
 ...
 */
const HERMES_REPLY_NOTE = `## Replying to short messages
...
NO_REPLY is only for mentions that are not addressed to you: your name used as
a label rather than an address — an ability note in a task description, a
third-person reference to you, your name inside quoted text. Nobody is waiting
on those.`;
